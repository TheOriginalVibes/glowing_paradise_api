package at.vibes.libInventorys.content;
...
public interface InventoryContents {
    ...
    class Impl implements InventoryContents {
        ...
        private final LibInventory inv;
        ...
        public Impl(LibInventory inv, UUID player) {
            this.inv = inv;
            this.player = player;
        ...
        @Override
        public LibInventory inventory() { return inv; }
