...
public enum ChatColor {
    ...
    private static final HashMap<Byte, ChatColor> BY_CODE;
    private static final Map<Character, ChatColor> BY_CHAR;
    private final char character;
    private final byte code;
    private final String string;

    ChatColor(char character, int code) {
    ...
    public ChatColor getByCharacter(char character) {
        return BY_CHAR.get(character);
    }

    public ChatColor getByCode(int code) {
        return getByCode((byte)code);
    }

    public ChatColor getByCode(byte code) {
        return BY_CODE.get(code);
    }

    public String stripColors(String string) {
        if (string == null) {
            return null;
        }
    ...
    public String translateHexColorCodes(String text) {
        return StringReplacer.of(text);
    }
    ...
    static {
        ...
        for (ChatColor chatColor : values()) {
            BY_CHAR.put(chatColor.getChar(), chatColor);
